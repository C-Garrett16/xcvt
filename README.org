#+title: README
#+AUTHOR: Garrett Reid
#+DESCRIPTION: A markup file for my xcvt program.
#+PROPERTY: header-args :tangle xcvt.cpp
...
* The Includes
- Libraies included in this project
#+begin_src cpp
...
* Maps definitions
- This is the definitions of the unordered maps. Also including the version number, and a couple functions.
...
* Functions
- Function declarations/definitions live here.
#+begin_src cpp
void print_usage() {
